...
int main(){
    ...
    cout << "\nDigite o codigo do pedido do seu lanche(100,101,102 ou 104) e sua quantidade respectivamente: ";
    ...
    cout << "\nDigite o codigo da sua bebida(105,106 ou 107) e sua quatidade respectivamente: ";
